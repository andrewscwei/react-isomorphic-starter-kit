  ...
  render() {
    ...
    return (
      <html>
        ...
        <body>
          <script dangerouslySetInnerHTML={{ __html: `window.__VERSION__='${__APP_CONFIG__.version}';` }}/>
          <script dangerouslySetInnerHTML={{ __html: `window.__BUILD_NUMBER__='${__APP_CONFIG__.buildNumber}';` }}/>
          { initialState &&
